 ...
 */
    ...
    public class ListarClientes extends CursorAdapter {
        public ListarClientes(Context context, Cursor cursor) {
        ...
        public View newView(Context context, Cursor cursor, ViewGroup parent) {
            return LayoutInflater.from(context).inflate(R.layout.activity_buscar_cliente, parent, false);
        }
