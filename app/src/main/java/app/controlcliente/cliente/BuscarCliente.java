...
public class BuscarCliente extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SQLiteDatabase db = bdClientes.getWritableDatabase();
        Cursor cursor = bdClientes.listarclientes();

        ListView lvlitems = (ListView) findViewById(R.id.lvlitems);
        lvlitems.setTextFilterEnabled(true);
        final ListarClientes todoAdapter = new ListarClientes(this, cursor);
